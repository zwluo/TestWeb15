      ...
      var defaults = {
        ...
        pdfmake: {
          ...
          docDefinition: {
            ...
            defaultStyle: {
              font: 'Roboto'              // default is 'Roboto', for arabic font set this option to 'Mirza' and include mirza_fonts.lib
            }
          },
          fonts: {}
        },
            ...
            ForEachVisibleCell(this, 'th,td', rowIndex, $hrows.length,
              function (cell, row, col) {
                if ( cell !== null ) {
                  ...
                  var tdcolspan = $(cell).data("tableexport-rowspan");
                  if ( typeof tdcolspan == 'undefined' && $(cell).is("[rowspan]") )
                    tdcolspan = $(cell).attr('colspan');
                  if ( typeof tdcolspan !== 'undefined' && tdcolspan !== '' )
                    trData += ' rowspan="' + tdcolspan + '"';
      ...
      */
      ...
      function prepareAutoTableText (cell, data, cellopt) {
        ...
        if ( cs >= 0 ) {
          ...
          return false; // cell is hidden (rowspan = -1), don't draw it
      }

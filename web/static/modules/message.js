...
layui.define(['admin', 'table', 'util'], function(exports){
  ...
  ,tabs = {
    ...
    ,notice: {
      text: '通知'
      ,id: 'LAY-app-msg-notice'
    }
    ,direct: {
      text: '私信'
      ,id: 'LAY-app-msg-direct'
    }
  };
  ...
  //全部消息
  table.render({
    elem: '#LAY-app-msg-all'
    ,url: layui.setter.base + 'json/msg/all.lib' //模拟接口
    ,page: true
    ,cols: [[
  ...
  //通知
  table.render({
    elem: '#LAY-app-msg-notice'
    ,url: layui.setter.base + 'json/msg/notice.lib' //模拟接口
    ,page: true
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field: 'title', title: '标题内容', minWidth: 300, templet: tplTitle}
  ...
  //私信
  table.render({
    elem: '#LAY-app-msg-direct'
    ,url: layui.setter.base + 'json/msg/direct.lib' //模拟接口
    ,page: true
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field: 'title', title: '标题内容', minWidth: 300, templet: tplTitle}
  ...
  $('.LAY-app-msg-btns .layui-btn').on('click', function(){
    var othis = $(this)
